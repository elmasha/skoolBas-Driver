...
public class FollowingAdapter extends FirestoreRecyclerAdapter<Followers, FollowingAdapter.InboxViewHolder> {
    ...
    public FollowingAdapter(@NonNull FirestoreRecyclerOptions<Followers> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull InboxViewHolder holder, int i, @NonNull Followers model) {
